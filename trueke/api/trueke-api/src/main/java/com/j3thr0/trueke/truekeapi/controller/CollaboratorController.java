...
public class CollaboratorController {
    ...
    public ResponseEntity<UserResponse> updateCollaborator(
            @PathVariable UUID collaborator_id,
            @RequestBody UpdateCollaboratorRequest updateCollaboratorRequest
    ) {
        Collaborator collaborator = collaboratorService.findById(collaborator_id);
        Collaborator modified = collaboratorService.editCollaborator(collaborator, updateCollaboratorRequest);
